    ...
    <div className="space-y-8 px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 bg-gray-50 min-h-screen">
          ...
          <ul className="space-y-4 text-sm sm:text-base">
            ...
            <li className="flex flex-col sm:flex-row sm:justify-between gap-1">
              <span className="text-gray-700">
                User Anna created a new listing
              </span>
              <span className="text-xs sm:text-sm text-gray-400">
                5 hours ago
              </span>
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-5 md:p-6 shadow">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <button className="w-full rounded-xl bg-black text-white py-3 text-sm sm:text-base hover:bg-gray-800 transition">
            Add New Listing
          </button>
          <button className="w-full rounded-xl bg-gray-100 text-gray-800 py-3 text-sm sm:text-base hover:bg-gray-200 transition">
            Manage Users
          </button>
          <button className="w-full rounded-xl bg-gray-100 text-gray-800 py-3 text-sm sm:text-base hover:bg-gray-200 transition">
            View Reports
