            ...
            {sidebarOpen && (
                <div className="fixed inset-0 z-50 flex lg:hidden">
                    ...
                    <aside className="relative w-64 bg-black text-white flex flex-col">
                        ...
                        <nav className="flex-1 px-4 py-6 space-y-2">
                            <Link onClick={() => setSidebarOpen(false)} href="/admin/dashboard" className={linkClass("/admin/dashboard")}>
                                Dashboard
                            </Link>
                            <Link onClick={() => setSidebarOpen(false)} href="/admin/user" className={linkClass("/admin/user")}>
                                User
                            </Link>
                            <Link onClick={() => setSidebarOpen(false)} href="/admin/location" className={linkClass("/admin/location")}>
                                Location
                            </Link>
                            <Link onClick={() => setSidebarOpen(false)} href="/admin/listing" className={linkClass("/admin/listing")}>
                                Listing
                            </Link>
                            <Link onClick={() => setSidebarOpen(false)} href="/admin/booking" className={linkClass("/admin/booking")}>
                                Booking
                            </Link>
                        </nav>
                    </aside>
